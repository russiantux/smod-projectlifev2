...
function CheckEnemy()
	...
	local ent2 = HL2.FindEntityByName(nil, "antlion_guard")
	if ent2 == nil then 
	HL2.CallMapaddLabel("ants_clear")
	ANT_FLG = true 
	elseif ent2 ~= nil then found = found + 1
	ANT_FLG = false 
	end
	
	if found == 0 and END_FLG == false and ANT_FLG == true then

		HL2.CallMapaddLabel("clear")
		END_FLG = true
	elseif END_FLG == false then
		HL2.ShowHUDMessage("\n\n\n\n\n\n" .. found .. " targets remaining")
	end 
