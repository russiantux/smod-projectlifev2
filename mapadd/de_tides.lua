...
function cannisters()
	...
	local org = HL2.Vector(520, -457, 63)
	local ang = HL2.Vector(-44, 176, 0)
	local cannister01 = HL2.CreateEntity("env_headcrabcanister", org, ang)
		...
		HL2.KeyValue(cannister01, "angles", "-44, 176, 0")
	...
	local org = HL2.Vector(-1193, 98, -3)
	local ang = HL2.Vector(-52, -67, 0)
	local cannister01 = HL2.CreateEntity("env_headcrabcanister", org, ang)
		HL2.KeyValue(cannister01, "SmokeLifetime", "240")
		...
		HL2.KeyValue(cannister01, "HeadcrabCount", HL2.RandomInt(4,6))
		HL2.KeyValue(cannister01, "HeadcrabType", HL2.RandomInt(0,2))
		HL2.KeyValue(cannister01, "angles", "-52, -67, 0")
	...
	local org = HL2.Vector(-1450, -159, 50)
	local ang = HL2.Vector(-46, 3, 0)
	local cannister01 = HL2.CreateEntity("env_headcrabcanister", org, ang)
		HL2.KeyValue(cannister01, "SmokeLifetime", "240")
		...
		HL2.KeyValue(cannister01, "HeadcrabCount", HL2.RandomInt(4,6))
		HL2.KeyValue(cannister01, "HeadcrabType", HL2.RandomInt(0,2))
		HL2.KeyValue(cannister01, "angles", "-46, 3, 0")
