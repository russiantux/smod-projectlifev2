...
--These are Boolean values. 1 means yes, spawn these entities. 0 means no, do not spawn. TeamAlyx consists of Alyx and Barney plus a randomly chosen special teammate. 
...
local	HOSTAGESPAWNPOINT = "hostage_entity"
...
function SpawnCombine(org, ang, sqn)
	...
	if( cb ~= nil ) then
		...
		--cops need hacks, but not in a cs map.
		if npcname == "npc_metropolice" then
		HL2.KeyValue(cb, "manhacks", "0")
		end
