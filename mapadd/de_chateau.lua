...
local	CITIZENNUM = HL2.RandomInt(3,6)
local	COMBINENUM = 16
...
function cannisters()
	...
	local org = HL2.Vector(773, -94, 80)
	local ang = HL2.Vector(-44, 97, 0)
	local cannister01 = HL2.CreateEntity("env_headcrabcanister", org, ang)
		HL2.KeyValue(cannister01, "SmokeLifetime", "240")
		HL2.KeyValue(cannister01, "targetname", "cannister01")
		--the damage for this is different because I want it to break a nearby window
		HL2.KeyValue(cannister01, "DamageRadius", "400")
		HL2.KeyValue(cannister01, "Damage", "50")
		HL2.KeyValue(cannister01, "SkyboxCannisterCount", "4")
		HL2.KeyValue(cannister01, "StartingHeight", "0")
		HL2.KeyValue(cannister01, "FlightTime", "1.5")
		HL2.KeyValue(cannister01, "FlightSpeed", "2700")
		HL2.KeyValue(cannister01, "HeadcrabCount", HL2.RandomInt(4,6))
		HL2.KeyValue(cannister01, "HeadcrabType", HL2.RandomInt(0,2))
		HL2.KeyValue(cannister01, "angles", "-44, 97, 0")
		HL2.KeyValue(cannister01, "OnImpacted", "cannister01,OpenCanister,,0.5,-1")
		HL2.KeyValue(cannister01, "OnOpened", "cannister01,SpawnHeadcrabs,,1,-1")
		HL2.SpawnEntity(cannister01)
		
	local it = HL2.CreateEntity("instant_trig", VECTORZERO, VECTORZERO)
	if( it ~= nil ) then
		HL2.KeyValue(it, "label", "cann1")	
		HL2.KeyValue(it, "timer", HL2.RandomInt(1,240))
		HL2.SpawnEntity(it)
	end
	
	local org = HL2.Vector(766, 1001, 98)
	local ang = HL2.Vector(-70, 87, 0)
	local cannister01 = HL2.CreateEntity("env_headcrabcanister", org, ang)
		HL2.KeyValue(cannister01, "SmokeLifetime", "240")
		HL2.KeyValue(cannister01, "targetname", "cannister02")
		HL2.KeyValue(cannister01, "DamageRadius", "100")
		HL2.KeyValue(cannister01, "Damage", "100")
		HL2.KeyValue(cannister01, "SkyboxCannisterCount", "4")
		HL2.KeyValue(cannister01, "StartingHeight", "0")
		HL2.KeyValue(cannister01, "FlightTime", "1.5")
		HL2.KeyValue(cannister01, "FlightSpeed", "2700")
		HL2.KeyValue(cannister01, "HeadcrabCount", HL2.RandomInt(4,6))
		HL2.KeyValue(cannister01, "HeadcrabType", HL2.RandomInt(0,2))
		HL2.KeyValue(cannister01, "angles", "-70, 87, 0")
		HL2.KeyValue(cannister01, "OnImpacted", "cannister02,OpenCanister,,0.5,-1")
		HL2.KeyValue(cannister01, "OnOpened", "cannister02,SpawnHeadcrabs,,1,-1")
		HL2.SpawnEntity(cannister01)
		
	local it = HL2.CreateEntity("instant_trig", VECTORZERO, VECTORZERO)
	if( it ~= nil ) then
		HL2.KeyValue(it, "label", "cann2")	
		HL2.KeyValue(it, "timer", HL2.RandomInt(1,240))
		HL2.SpawnEntity(it)
	end
	
	local org = HL2.Vector(-324, 944, 80)
	local ang = HL2.Vector(-81, 22, 0)
	local cannister01 = HL2.CreateEntity("env_headcrabcanister", org, ang)
		HL2.KeyValue(cannister01, "SmokeLifetime", "240")
		HL2.KeyValue(cannister01, "targetname", "cannister03")
		HL2.KeyValue(cannister01, "DamageRadius", "100")
		HL2.KeyValue(cannister01, "Damage", "100")
		HL2.KeyValue(cannister01, "SkyboxCannisterCount", "4")
		HL2.KeyValue(cannister01, "StartingHeight", "0")
		...
		HL2.KeyValue(cannister01, "HeadcrabCount", HL2.RandomInt(4,6))
		HL2.KeyValue(cannister01, "HeadcrabType", HL2.RandomInt(0,2))
		HL2.KeyValue(cannister01, "angles", "-81, 22, 0")
		HL2.KeyValue(cannister01, "OnImpacted", "cannister03,OpenCanister,,0.5,-1")
		HL2.KeyValue(cannister01, "OnOpened", "cannister03,SpawnHeadcrabs,,1,-1")
		HL2.SpawnEntity(cannister01)
		
	local it = HL2.CreateEntity("instant_trig", VECTORZERO, VECTORZERO)
	if( it ~= nil ) then
		HL2.KeyValue(it, "label", "cann3")	
		HL2.KeyValue(it, "timer", HL2.RandomInt(1,240))
		HL2.SpawnEntity(it)
	end
	
	local org = HL2.Vector(-204, 1371, 82)
	local ang = HL2.Vector(-89, 90, 0)
	local cannister01 = HL2.CreateEntity("env_headcrabcanister", org, ang)
		HL2.KeyValue(cannister01, "SmokeLifetime", "240")
		HL2.KeyValue(cannister01, "targetname", "cannister04")
		HL2.KeyValue(cannister01, "DamageRadius", "100")
		HL2.KeyValue(cannister01, "Damage", "100")
		HL2.KeyValue(cannister01, "SkyboxCannisterCount", "4")
		HL2.KeyValue(cannister01, "StartingHeight", "0")
		...
		HL2.KeyValue(cannister01, "HeadcrabCount", HL2.RandomInt(4,6))
		HL2.KeyValue(cannister01, "HeadcrabType", HL2.RandomInt(0,2))
		HL2.KeyValue(cannister01, "angles", "-89, 90, 0")
		HL2.KeyValue(cannister01, "OnImpacted", "cannister04,OpenCanister,,0.5,-1")
		HL2.KeyValue(cannister01, "OnOpened", "cannister04,SpawnHeadcrabs,,1,-1")
		HL2.SpawnEntity(cannister01)
		
	local it = HL2.CreateEntity("instant_trig", VECTORZERO, VECTORZERO)
	if( it ~= nil ) then
		HL2.KeyValue(it, "label", "cann4")	
		HL2.KeyValue(it, "timer", HL2.RandomInt(1,240))
		HL2.SpawnEntity(it)
	end
	
	local org = HL2.Vector( 133, 65, -11)
	local ang = HL2.Vector(-45, -86, 0)
	local cannister01 = HL2.CreateEntity("env_headcrabcanister", org, ang)
		HL2.KeyValue(cannister01, "SmokeLifetime", "240")
		HL2.KeyValue(cannister01, "targetname", "cannister05")
		HL2.KeyValue(cannister01, "DamageRadius", "100")
		HL2.KeyValue(cannister01, "Damage", "100")
		HL2.KeyValue(cannister01, "SkyboxCannisterCount", "4")
		HL2.KeyValue(cannister01, "StartingHeight", "0")
		...
		HL2.KeyValue(cannister01, "HeadcrabCount", HL2.RandomInt(4,6))
		HL2.KeyValue(cannister01, "HeadcrabType", HL2.RandomInt(0,2))
		HL2.KeyValue(cannister01, "angles", "-45, -86, 0")
		HL2.KeyValue(cannister01, "OnImpacted", "cannister05,OpenCanister,,0.5,-1")
		HL2.KeyValue(cannister01, "OnOpened", "cannister05,SpawnHeadcrabs,,1,-1")
		HL2.SpawnEntity(cannister01)
		
	local it = HL2.CreateEntity("instant_trig", VECTORZERO, VECTORZERO)
	if( it ~= nil ) then
		HL2.KeyValue(it, "label", "cann5")	
		HL2.KeyValue(it, "timer", HL2.RandomInt(1,240))
		HL2.SpawnEntity(it)
	end
	
	local org = HL2.Vector( 1432, 1048, 51)
	local ang = HL2.Vector(-31, -87, 0)
	local cannister01 = HL2.CreateEntity("env_headcrabcanister", org, ang)
		HL2.KeyValue(cannister01, "SmokeLifetime", "240")
		HL2.KeyValue(cannister01, "targetname", "cannister06")
		HL2.KeyValue(cannister01, "DamageRadius", "100")
		HL2.KeyValue(cannister01, "Damage", "100")
		HL2.KeyValue(cannister01, "SkyboxCannisterCount", "4")
		HL2.KeyValue(cannister01, "StartingHeight", "0")
		...
		HL2.KeyValue(cannister01, "HeadcrabCount", HL2.RandomInt(4,6))
		HL2.KeyValue(cannister01, "HeadcrabType", HL2.RandomInt(0,2))
		HL2.KeyValue(cannister01, "angles", "-31, -87, 0")
		HL2.KeyValue(cannister01, "OnImpacted", "cannister06,OpenCanister,,0.5,-1")
		HL2.KeyValue(cannister01, "OnOpened", "cannister06,SpawnHeadcrabs,,1,-1")
		HL2.SpawnEntity(cannister01)
		
	local it = HL2.CreateEntity("instant_trig", VECTORZERO, VECTORZERO)
	if( it ~= nil ) then
		HL2.KeyValue(it, "label", "cann6")	
		HL2.KeyValue(it, "timer", HL2.RandomInt(1,240))
		HL2.SpawnEntity(it)
	end
