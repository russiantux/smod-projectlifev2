...
--This map can be played from either direction. Switch the comments (two hyphens) around to trade spawn points.
...
--these are the combine tools. The rollermine is a real pain without the gravity gun, (which you won't get in this game) but you can avoid it or blow it up with explosives (a direct hit with an smg grenade will do the job, or try tossing a grenade, then push the mine towards it with fire from your rifle).
...
function cannisters()
	...
	local org = HL2.Vector(-71, -491, -137)
	local ang = HL2.Vector(-67, 18, 0)
	local cannister01 = HL2.CreateEntity("env_headcrabcanister", org, ang)
		...
		HL2.KeyValue(cannister01, "DamageRadius", "200")
		...
		HL2.KeyValue(cannister01, "angles", "-67, 18, 0")
		...
		HL2.KeyValue(cannister01, "OnOpened", "fire_a,startfire,,5,-1")
	...
	local org = HL2.Vector(3259, -651, -415)
	local ang = HL2.Vector(-88, 75, 0)
	local cannister01 = HL2.CreateEntity("env_headcrabcanister", org, ang)
		HL2.KeyValue(cannister01, "SmokeLifetime", "240")
		...
		HL2.KeyValue(cannister01, "HeadcrabCount", HL2.RandomInt(4,6))
		HL2.KeyValue(cannister01, "HeadcrabType", HL2.RandomInt(0,2))
		HL2.KeyValue(cannister01, "angles", "-88, 75, 0")
	...
	local org = HL2.Vector(3744, -97, -438)
	local ang = HL2.Vector(-88, 75, 0)
	local cannister01 = HL2.CreateEntity("env_headcrabcanister", org, ang)
		HL2.KeyValue(cannister01, "SmokeLifetime", "240")
